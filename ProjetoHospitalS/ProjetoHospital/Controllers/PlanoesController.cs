...
namespace ProjetoHospital.Controllers
{
    public class PlanoesController : Controller
    {
        ...
        public PlanoesController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sigla")] Plano plano)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sigla")] Plano plano)
        {
            if (id != plano.Id)
            {
                return NotFound();
